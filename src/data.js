...
export const data = [
  {
    title: "Gyudon",
    tags: ["Japanese", "Lunch"],
    image: require("./images/gyudon.jpeg")
  },
  {
    title: "Teppan Beef",
    tags: ["Japanese", "Lunch"],
    image: require("./images/teppan beef.jpeg")
  },
  {
    title: "Niku Udon",
    tags: ["Japanese", "Lunch"],
    image: require("./images/niku udon.webp")
  },
  {
    title: "Chocolate Eclair",
    tags: ["Pastry"],
    recipeAvailable: true,
    image: require("./images/eclair.jpeg"),
    prepTime: '15 mins',
    totalTime: '1 hour',
    portions: '24',
    ingredients: [
...
].map(item => ({ ...item, id: kebabCase(item.title) }));

export const tags = [...new Set(data.map(({ tags }) => tags).flat(1))].sort();
